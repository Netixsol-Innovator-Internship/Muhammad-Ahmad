            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">amedbrat@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">+92 9070630506</p>
                </div>
              </div>
            ...
            <div className="mt-8">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Standard delivery takes 3-5 business days. Express shipping is available.</p>
                </div>
                <div>
                  <h4 className="font-medium text-gray-900">Do you offer tea samples?</h4>
                  <p className="text-sm text-gray-600">Yes! We offer samples for all our tea varieties to help you find your perfect blend.</p>
                </div>
                <div>
                  <h4 className="font-medium text-gray-900">What's your return policy?</h4>
                  <p className="text-sm text-gray-600">We offer a 30-day satisfaction guarantee on all unopened products.</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent"
