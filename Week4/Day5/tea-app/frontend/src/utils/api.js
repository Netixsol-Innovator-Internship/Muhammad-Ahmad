...
export const cartAPI = {
  ...
  addToCart: (productId, qty = 1) => api.post('/cart', { productId, qty }),
  updateCartItem: (itemId, qty) => api.put(`/cart/item/${itemId}`, { qty }),
  removeCartItem: (itemId) => api.delete(`/cart/item/${itemId}`),
